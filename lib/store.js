...
// On Vercel the whole bundle is read-only and only the OS temp dir is writable, so
// fall back to it there. NOTE: that dir is ephemeral and per-instance — data does
// not persist across cold starts. For durable storage on Vercel, set DATA_DIR to a
// mounted volume or switch this module to a database.
